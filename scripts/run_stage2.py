...
(Equivalent single run: ``python -m vesp.feasibility.training.train --config configs/feasibility/discrete_multishell.yaml``.)
...
def main() -> None:
    ...
    subprocess.check_call([sys.executable, "-m", "vesp.feasibility.training.train", "--config", "configs/feasibility/discrete_multishell.yaml"], cwd=ROOT)
