...
(Equivalent single run: ``python -m vesp.training.train --config configs/feasibility/discrete_single_shell.yaml``.)
...
def main() -> None:
    ...
    subprocess.check_call([sys.executable, "-m", "vesp.training.train", "--config", "configs/feasibility/discrete_single_shell.yaml"], cwd=ROOT)
