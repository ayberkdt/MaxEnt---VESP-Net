...
def summary_row(
    ...
    *,
    ...
    ``metrics`` is the dict returned by ``vesp.feasibility.training.train_discrete.run`` (which
...
def _suite_readme(suite_name: str, experiments: list[str], rows: list[dict], extra: str | None) -> str:
    lines = [
        f"# {suite_name}",
        "",
        "Generated by `vesp.feasibility.experiments`. This directory aggregates one or more",
